...
class Prime_Slider_Loader {
	...
	public function register_site_scripts() {
		...
		if (bdt_ps()->is__premium_only()) {
			...
			if (prime_slider_is_widget_enabled('woohotspot')) {
				wp_register_script('popper', BDTPS_ASSETS_URL . 'vendor/js/popper.min.js', ['jquery'], null, true);
				wp_register_script('tippyjs', BDTPS_ASSETS_URL . 'vendor/js/tippy.all.min.js', ['jquery'], null, true);
			}
			if (prime_slider_is_widget_enabled('fortune') or prime_slider_is_widget_enabled('knily') or prime_slider_is_widget_enabled('storker') or prime_slider_is_widget_enabled('omatic') or prime_slider_is_widget_enabled('sniper') or prime_slider_is_widget_enabled('mercury') or prime_slider_is_widget_enabled('coddle') or prime_slider_is_widget_enabled('escape') or prime_slider_is_widget_enabled('titanic') or prime_slider_is_widget_enabled('woohotspot')) {
				wp_register_script('shutters', BDTPS_ASSETS_URL . 'vendor/js/effect-shutters.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
				wp_register_script('gl', BDTPS_ASSETS_URL . 'vendor/js/swiper-gl.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
				wp_register_script('slicer', BDTPS_ASSETS_URL . 'vendor/js/effect-slicer.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
				wp_register_script('tinder', BDTPS_ASSETS_URL . 'vendor/js/effect-tinder.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
			}
		}
	...
	public function register_site_styles() {
		...
		if (bdt_ps()->is__premium_only()) {
			if (prime_slider_is_widget_enabled('woohotspot')) {
				wp_register_style('tippy', BDTPS_ASSETS_URL . 'css/tippy' . $direction_suffix . '.css', [], BDTPS_VER);
			}
		}
	}
