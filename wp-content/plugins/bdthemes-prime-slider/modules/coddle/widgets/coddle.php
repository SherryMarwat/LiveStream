...
class Coddle extends Widget_Base {
		...
		*/
		...
		$this->add_responsive_control(
            ...
            [
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-coddle-slider .bdt-pagination-wrap' => '{{VALUE}} !important;',
				],
				'toggle' => false
            ]
        );
	...
	public function render_sub_title($slide) {
		...
		?>
		<<?php echo Utils::get_valid_html_tag($settings['sub_title_html_tag']); ?> class="bdt-sub-title" data-swiper-parallax-y="-70" data-swiper-parallax-duration="600">
