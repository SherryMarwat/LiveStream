...
class Fortune extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'   => esc_html__( 'Style', 'bdthemes-prime-slider' ) . BDTPS_NC,
	...
	public function render_sub_title($slide) {
		...
		?>
		<<?php echo Utils::get_valid_html_tag($settings['sub_title_html_tag']); ?> class="bdt-sub-title" data-reveal="reveal-active">
