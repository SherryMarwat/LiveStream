...
class Knily extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'loop',
            [
                'label'   => __('Loop', 'bdthemes-prime-slider') . BDTPS_NC,
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
    ...
    public function render_image($post_id, $size) {
        ...
        if (!$image_src) {
            printf('<img src="%1$s" alt="%2$s" class="bdt-knily-img swiper-lazy %3$s">', $placeholder_image_src, esc_html(get_the_title()), $gl . $shutters);
        } else {
