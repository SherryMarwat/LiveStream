<?php
namespace PrimeSlider\Modules\Titanic\Widgets;
...
class Titanic extends Widget_Base {
				...
				<?php foreach ($settings['slides'] as $slide) : ?>
					<div class="swiper-slide bdt-titanic-item">
						...
						<?php if ($slide['title'] && ('yes' == $settings['show_title'])) : ?>
							...
							<<?php echo Utils::get_valid_html_tag($settings['title_html_tag']); ?> class="bdt-title" data-swiper-parallax="-100">
						...
						<?php if ($slide['title'] && ('yes' == $settings['show_title'])) : ?>
							<<?php echo Utils::get_valid_html_tag($settings['title_html_tag']); ?> class="bdt-titanic-main-title" data-swiper-parallax="-150" data-swiper-parallax-duration="900">
								<?php if ('' !== $slide['title_link']['url']) : ?>
									<a href="<?php echo esc_url($slide['title_link']['url']); ?>">
									<?php endif; ?>
									<?php echo prime_slider_first_word($slide['title']); ?>
	...
	public function render_sub_title($slide) {
		...
		?>
		<<?php echo Utils::get_valid_html_tag($settings['sub_title_html_tag']); ?> class="bdt-titanic-sub-title" data-swiper-parallax="-100" data-swiper-parallax-duration="600">
	...
	public function rendar_item_image($item, $alt = '') {
		...
		<div class="bdt-titanic-image-wrap">
			<img class="bdt-titanic-img <?php echo esc_attr($gl . $shutters . $slicer); ?>" src="<?php echo esc_url($image_src); ?>" alt="<?php echo esc_html($alt); ?>">
		</div>
