...
if (typeof domain_advanced_iframe === 'undefined') {
    var domain_advanced_iframe = '//localhost/WatchPlay/wp-content/plugins/advanced-iframe'; // Check if this is this is the path to the main directory of aip
}
...
if (doIt) {
  ...
  if (typeof jquery_path === 'undefined') {
      var jquery_path = "//localhost/WatchPlay/wp-includes/js/jquery/jquery.js";
  }
