...
if (typeof domain_advanced_iframe === 'undefined') {
    var domain_advanced_iframe = '//localhost/livestream/wp-content/plugins/advanced-iframe'; // Check if this is this is the path to the main directory of aip
}
...
if (doIt) {
  ...
  if (typeof jquery_path === 'undefined') {
      var jquery_path = "//localhost/livestream/wp-includes/js/jquery/jquery.js";
  }
